---
title: "Homework1 Supervised Learning"
...
::: {.callout-note title="Solution"}
> The best achievable MSE are quadratic and linear because they come closer to the best achievable MSE of 9 than cubic does. This value of 9 comes from the variance of the noise in the data. Since the linear model performs with an MSE of 9.1767 and the quadratic model performs with an MSE of 9.1992, they are therefore very close at achieving the optimum.
:::
